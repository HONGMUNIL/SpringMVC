...
public class StudentStudyController {
    ...
    public ResponseEntity<SuccessResponseDto<Instructor>> addInstructor(@Valid @RequestBody ReqAddInstructorDto reqAddInstructorDto) {
    ...
    public ResponseEntity<SuccessResponseDto<?>> updateMajor(
            ...
            @PathVariable @Min(value = 1, message = "학과 ID는 1 이상의 정수여야합니다.")
            int majorId,
